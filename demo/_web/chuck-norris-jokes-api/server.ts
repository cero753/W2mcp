/**
 * Chuck Norris Jokes API MCP Server — GENERATED BY w2mcp from spec-less docs. Do not hand-edit.
...
server.tool(
  "list_categories",
  "Retrieve a list of available Chuck Norris joke categories.",
  {
      verbosity: z.enum(["compact", "full"]).optional().describe("Response detail level (default compact)."),
    },
  async (args: any) => {
...
server.tool(
  ...
  {
      "query": z.string().describe("The search term for Chuck Norris jokes."),
      verbosity: z.enum(["compact", "full"]).optional().describe("Response detail level (default compact)."),
    },
  async (args: any) => {
